...
"""
    ...
    def about(self):
        msg = """• Marketmoni bu ego mbinye na nweghi omurunwa Government Nigeria na-enye ndi na azu  ahia na ndi nwere obere ulo oru na gwurugwuru ala anyi.
• Ego mbinye a sitere na *₦50,000 - ₦250,000*.
• Oge eji akwugachi ego a bu onwa isii.
• Ego nhazi bu 5%.
• Iji maa atu, oburu na inata ₦50,000, iga akwugachi ₦52,500 bu nke iga na akwu *₦2,187.5* na izu uka obula. 
• Mgbe ikwugachiri ₦50,000 na onwa isii, iga etozu oke inata ₦100,000. ₦100,000 Ikwugachi ya, inata ₦250,000.
...
• Nye onye okwu ugwo AKARA
   ...
   na ego mbinye Marketmoni.

• Nara akwukwo na egosi na ikwuru ugwo.

*➣*     *IJI SCRATCH CARD AKWU UGWO*
Gaa zuta Marketmoni scratch card site na aka onye OneCard agent obula no gi nso, Lee anya ofuma na ebe atuziri aka etu iga esi akwu ugwo gi
...
class SpeakToAgent(WhatsBot):
    ...
    def greet(self):
        msg= "Akara ekwe nti Marketmoni bu *07006275386*"
        msg += "\n\nPia efu maka ilagachi azu na ebe ibidoro"
