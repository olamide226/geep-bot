...
"""
    ...
    def about(self):
        msg = """• FarmerMoni is an interest-free loan from the *Federal Government of Nigeria* to help small and *medium scale farmers* across the country.
• Loan range is from *₦300,000 - ₦1,000,000*.
• loan tenure is within *9months*.
• Administration fee is *7.5%*.
• For example, if you collect ₦300,000,you will pay back ₦322,500.
• When you payback your first ₦322,500 within 9months, you can get up to ₦1,000,000 for your next loan.
...
class SpeakToAgent(WhatsBot):
    ...
    def greet(self):
        msg= "The Number to call is *0700 6275 386* for FarmerMoni"
        msg += "\n\nPress 0 to go back to main menu"
