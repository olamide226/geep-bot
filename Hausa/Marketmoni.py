...
"""
    ...
    def about(self):
        msg = """• MarketMoni bashi ne mara riba wanda gwamnatin tarayyan najeriya take bama yan kasuwa, masu kananan masana’antu (SMEs) a fadin kasar najeriya.
• Bashin ya kama daga *₦50,000 - ₦250,000*.
• Lokacin biya cikin *wata 6* ne.
• 5 % ne kudin aiki akan bashin.
• Misali, idan aka amsa ₦50,000, za’a biya ₦52,500 ta tsarin biyan *₦2,187.5* duk mako. 
• Bayan an gama biyan ₦50,000 cikin watanni 6, zaka samu cancantar samun bashin ₦100,000. bayan nan sai ka/ki samu ₦250,000.
...
class SpeakToAgent(WhatsBot):
    ...
    def greet(self):
        msg= "Kira lambar nan *0700 627 5386* domin MarketMoni"
        msg += "\n\nDanna 0 domin komawa shafin tsaretsare"
